        ...
        <div class="mt-8">
            ...
            >
                ...
                <textarea name="preview"
                          class="w-full border @error('preview') border-red-500 @enderror rounded px-3"
                          rows="6"
                          placeholder="{{ __('validation.attributes.preview') }}"
                >{{ old('preview', $post->preview) }}</textarea>
                @error('preview')
                <p class="text-red-500">{{ $message }}</p>
                @enderror
                <textarea name="description"
                          class="w-full border @error('description') border-red-500 @enderror rounded px-3"
                          rows="6"
